...
class FullDatasetProcessor:
    ...
    def load_full_shark_data(self, file_path: str = 'sharks_cleaned.csv') -> pd.DataFrame:
        """Load the full shark dataset"""
        logger.info(f"Loading full shark dataset from {file_path}")
...
def main():
    ...
    df.to_csv('integrated_data_full.csv', index=False)
    logger.info("Saved full processed data to integrated_data_full.csv")
    ...
    print("\nGenerated files:")
    print("  - integrated_data_full.csv (Full processed data)")
